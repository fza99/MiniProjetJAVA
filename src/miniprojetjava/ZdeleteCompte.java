 ...
 * @author asus
 */
public class ZdeleteCompte extends JDialog {
  private Client zInfo = new Client();
  private boolean sendData;
  private JLabel  codeLabel , icon;
 // private JRadioButton tranche1, tranche2, tranche3, tranche4;
  //private JComboBox sexe, cheveux;
  private JTextField codeCompte;

  public ZdeleteCompte(JFrame parent, String title, boolean modal){
  ...
  private void initComponent(){
    ...
    codeLabel = new JLabel("Saisir un cin :");
    ...
    okBouton.addActionListener(new ActionListener(){
      ...
      public void actionPerformed(ActionEvent arg0) {     
        ...
        try {
			...
			String sql = "delete from compte where codeCompte = "+codeCompte.getText();

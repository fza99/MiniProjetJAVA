 ...
 * @author asus
 */
public class ZzzAllcompte extends JDialog {
 ...
 // private JRadioButton tranche1, tranche2, tranche3, tranche4;
  ...
  public ZzzAllcompte(JFrame parent, String title, boolean modal){
  ...
  private void initComponent(){
	  ...
	  try {
		...
		while(cont) {
		     ...
		     donnees[a][1]=result.getDouble(2);
		     a++;
		     cont=result.next();
		  }
	} catch (SQLException e) {
      ...
      String[] entetes = {"codeCompte", "Solde"};

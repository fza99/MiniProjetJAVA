 ...
 * @author asus
 */
public class Zclient extends JDialog {
 ...
 // private JRadioButton tranche1, tranche2, tranche3, tranche4;
  ...
  public Zclient(JFrame parent, String title, boolean modal){
    ...
    okBouton.addActionListener(new ActionListener(){
      ...
      public void actionPerformed(ActionEvent arg0) {     
        ...
        try {
             ...
             String sql="insert into client(cin,nom) values('"+cin.getText()+"','"+nom.getText()+"')";       	              

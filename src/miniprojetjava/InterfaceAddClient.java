 ...
 * @author asus
 */
public class InterfaceAddClient extends JFrame{
  ...
  private JMenuItem item3 = new JMenuItem("Ajouter");
 ...
 /* public static void main(String[] args){
    InterfaceGraphique zFen = new InterfaceGraphique();
  }*/

  public InterfaceAddClient(){

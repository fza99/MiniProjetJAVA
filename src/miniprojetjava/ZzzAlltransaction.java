 ...
 * @author asus
 */
public class ZzzAlltransaction extends JDialog {
 ...
 // private JRadioButton tranche1, tranche2, tranche3, tranche4;
  ...
  public ZzzAlltransaction(JFrame parent, String title, boolean modal){
  ...
  private void initComponent(){
	  ...
	  try {
		...
		while(cont) {
		     ...
		     donnees[a][1]=result.getString(3);
		     a++;
		     cont=result.next();
		  }
	} catch (SQLException e) {
      ...
      String[] entetes = {"codeCompte", "Montant"};

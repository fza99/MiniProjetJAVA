 ...
 * @author asus
 */
public class Zcompte extends JDialog {
  private Client zInfo = new Client();
  private boolean sendData;
  private JLabel nomLabel, codeLabel, cinLabel ,soldeLabel  , icon;
 // private JRadioButton tranche1, tranche2, tranche3, tranche4;
  //private JComboBox sexe, cheveux;
  private JTextField nom, code, solde, cin;

  public Zcompte(JFrame parent, String title, boolean modal){
    ...
    okBouton.addActionListener(new ActionListener(){
      ...
      public void actionPerformed(ActionEvent arg0) {     
        ...
        try {
             ...
             String sql="insert into compte(codeCompte,solde,cin) values('"+code.getText()+"','"+solde.getText()+"','"+cin.getText()+"')"; 
             String sql1="insert into client(cin,nom) values('"+cin.getText()+"','"+nom.getText()+"')";             
             ps.executeUpdate(sql);
             ps.executeUpdate(sql1);
             
             JOptionPane.showMessageDialog(null,"le compte est bien Ajoute! ");

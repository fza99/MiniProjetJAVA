 ...
 * @author asus
 */
public class ZcompteCourant extends JDialog {
  private Client zInfo = new Client();
  private boolean sendData;
  private JLabel nomLabel, codeLabel, cinLabel ,soldeLabel ,decouvertLabel , icon;
 // private JRadioButton tranche1, tranche2, tranche3, tranche4;
  //private JComboBox sexe, cheveux;
  private JTextField nom, code, solde, cin, decouvertAutorise;

  public ZcompteCourant(JFrame parent, String title, boolean modal){
  ...
  private void initComponent(){
   ...
   // panNom.setLayout(new BorderLayout());
    ...
    //Le tauxInteret
    JPanel pandecouvert = new JPanel();
    pandecouvert.setBackground(Color.white);
    pandecouvert.setPreferredSize(new Dimension(220, 60));
    decouvertAutorise = new JTextField();
    decouvertAutorise.setPreferredSize(new Dimension(100, 25));
    pandecouvert.setBorder(BorderFactory.createTitledBorder("le decouvert Autorise:"));
    decouvertLabel = new JLabel("le decouvert:");
    pandecouvert.add(decouvertLabel);
    pandecouvert.add(decouvertAutorise);
    ...
    okBouton.addActionListener(new ActionListener(){
      ...
      public void actionPerformed(ActionEvent arg0) {     
        ...
        try {
             ...
             String sql="insert into comptecourant(code,solde,cin,decouvertAutorise) values('"+code.getText()+"','"+solde.getText()+"','"+cin.getText()+"','"+decouvertAutorise.getText()+"')"; 
             String sql1="insert into client(cin,nom) values('"+cin.getText()+"','"+nom.getText()+"')";             
             ps.executeUpdate(sql);
             ps.executeUpdate(sql1);
             
             JOptionPane.showMessageDialog(null,"le compteCourant est bien Ajoute! ");
